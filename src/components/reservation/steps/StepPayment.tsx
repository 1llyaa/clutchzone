  ...
  return (
    <div className="flex flex-col gap-4" style={{ marginTop: 8 }}>
      <div className="flex justify-between border-b border-cz-gray-dark" style={{ paddingBottom: 12 }}>
        <span className="font-mono text-cz-gray-light uppercase" style={{ fontSize: 13, letterSpacing: 2 }}>{t('amountDue')}</span>
      ...
      <div className="flex items-center gap-2 justify-center">
        <span className="font-mono text-cz-orange" style={{ fontSize: 15, letterSpacing: 1 }}>{t('coinsAmount', { amount: coinsAmount })}</span>
